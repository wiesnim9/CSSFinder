...
This will create `dist/` directory with `cssfinder-0.4.0` or alike inside.

Wheel file can be installed with

```
pip install ./dist/cssfinder-0.4.0
```

What you expect is

```
Successfully installed cssfinder-0.4.0
```
...
But `cssfinder-0.4.0` should be included in this list.
