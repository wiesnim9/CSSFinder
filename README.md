...
This will create `dist/` directory with `cssfinder-0.1.0-py3-none-any.whl` or
alike inside.

Wheel file can be installed with

```
pip install ./dist/cssfinder-0.1.0-py3-none-any.whl
```

What you expect is

```
Successfully installed cssfinder-0.1.0
```
